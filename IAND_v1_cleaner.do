...
*Created by Luke Maier, Duke University
*(c) Luke Maier 2015

clear all
set more off
import delimited "C:\data\IAND_maier_v1_preprocessed.csv"
save "C:\data\IAND_maier_v1_preprocessed.dta", replace
...
save "C:\data\IAND_maier_v1.dta", replace
export delimited using "C:\data\IAND_maier_v1.dta", replace
